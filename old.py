...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕B X K▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : Bilal X Kajal
\033[1;92m☞ WhatsApp   : 03190857715
\033[1;95m☞ Facebook    : https://www.facebook.com/profile.php?id=100064292300639
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Bilal X kajal')
	print (S + '[' + P + '☞3' + S + ']' + S + ' No Group ')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Bilal x Kajal')
	    os.system('cd $HOME && git clone https://github.com/Bilal787750/KILLE')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
